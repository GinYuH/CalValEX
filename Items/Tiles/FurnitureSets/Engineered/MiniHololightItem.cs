...
{
    public class MiniHololightItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<MiniHololight>();
            Item.width = 34;
            Item.height = 30;
        ...
        {
            Recipe recipe = Recipe.Create(ModContent.ItemType<MiniHololightItem>());
            recipe.AddIngredient(ModContent.ItemType<HolographicGlassItem>(), 1);
