...
{
    public class EngineeredCrateItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<EngineeredCrate>();
            Item.width = 16;
            Item.height = 26;
        ...
        {
            Recipe recipe = Recipe.Create(ModContent.ItemType<EngineeredCrateItem>());
